...
namespace TheraBytes.BetterUi
{
    ...
    [ExecuteInEditMode]
#endif
    [HelpURL(RootDirectory.HelpUrl + "BetterTextMeshPro-InputField.html")]
    ...
    public class BetterTextMeshProInputField : TMP_InputField, IBetterTransitionUiElement, IResolutionDependency
    {
        ...
        public void CalculateSize()
        {
            if (overridePointSize)
                base.pointSize = pointSizeScaler.CalculateSize(this, nameof(pointSizeScaler));
        ...
        void OverrideBetterTextMeshSize(BetterTextMeshProUGUI better, float size)
        {
            ...
            {
                better.FontSizer.CalculateSize(this, nameof(better.FontSizer));
            }
