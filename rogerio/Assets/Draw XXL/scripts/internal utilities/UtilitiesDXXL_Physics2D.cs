namespace DrawXXL
{
    ...
    public class UtilitiesDXXL_Physics2D
    {
        ...
        public static ContactFilter2D GetContactFilterForNonAllocReplacements(int layerMask, float minDepth, float maxDepth)
        {
            ContactFilter2D contactFilter = new ContactFilter2D();
            contactFilter.useLayerMask = (layerMask != Physics2D.DefaultRaycastLayers);
            contactFilter.useDepth = ((minDepth != Mathf.NegativeInfinity) || (maxDepth != Mathf.Infinity));
