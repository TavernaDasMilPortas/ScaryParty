namespace DrawXXL
{
    ...
    public class UtilitiesDXXL_Components
    {
        ...
        static List<EntityId> id_ofMonobehavioursThatDrawViaOnDrawGizmos = new List<EntityId>();
#else
        ...
        public static void ReportOnDrawGizmosCycleOfAMonoBehaviour(Object reportingMonoB)
        {
#if UNITY_EDITOR
...
#if UNITY_6000_5_OR_NEWER
            EntityId id_ofReportingMonoB = reportingMonoB.GetEntityId();
#else
            int id_ofReportingMonoB = reportingMonoB.GetInstanceID();
#endif
