...
eturn SampleProbeVolumePixel( SampleSH( normalWS ), positionWS, normalWS, viewDirWS, input.positionCS.xy );
			...
			half4 CalculateShadowMask216_g1189(  )
			{
						 ...
						 ) : SV_Target
			{
				...
				float3 bakedGI361_g1187 = ASEIndirectDiffuse( input, ase_normalWS, WorldPosition, WorldViewDirection );
				Light ase_mainLight = GetMainLight( ShadowCoords );
				MixRealtimeAndBakedGI( ase_mainLight, ase_normalWS, bakedGI361_g1187, half4( 0, 0, 0, 0 ) );
				...
				float3 objToWorldDir37_g1192 = mul( GetObjectToWorldMatrix(), float4( normalizeResult6_g1192, 0.0 ) ).xyz;
				float3 objToWorldDir31_g1192 = mul( GetObjectToWorldMatrix(), float4( _CustomNormalDirection, 0.0 ) ).xyz;
				...
				float4 lerpResult22_g1187 = lerp( ( multiplyByLightColor201_g1187 == 1.0 ? ( float4( bakedGI361_g1187 , 0.0 ) * _ShadowColor ) : _ShadowColor ) , ( multiplyByLightColor201_g1187 == 1.0 ? ( ase_lightColor * _LightColor ) : _LightColor ) , lightRatio37_g1187);
				float4 FinalLighting134_g1187 = lerpResult22_g1187;
				float3 worldPosValue184_g1189 = WorldPosition;
				float3 WorldPosition175_g1189 = worldPosValue184_g1189;
				float4 ase_positionSSNorm = ScreenPos / ScreenPos.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
				float2 ScreenUV183_g1189 = (ase_positionSSNorm).xy;
				float2 ScreenUV175_g1189 = ScreenUV183_g1189;
				half4 localCalculateShadowMask216_g1189 = CalculateShadowMask216_g1189();
				float4 shadowMaskValue182_g1189 = localCalculateShadowMask216_g1189;
				float4 ShadowMask175_g1189 = shadowMaskValue182_g1189;
				float3 localAdditionalLightsFlatMask17x175_g1189 = AdditionalLightsFlatMask17x( WorldPosition175_g1189 , ScreenUV175_g1189 , ShadowMask175_g1189 );
				float3 posterizedLight236_g1187 = localAdditionalLightsFlatMask17x175_g1189;
				...
				float3 normalizeResult4_g1188 = normalize( ( WorldViewDirection + _MainLightPosition.xyz ) );
				float3 ModifiedNormal155_g1187 = ( _UseModifiedNormals == 0.0 ? ase_normalWS : temp_output_191_0_g1187 );
				...
				float4 FinalSpecular133_g1187 = ( ( multiplyByLightColor201_g1187 == 1.0 ? ase_lightColor : float4( 1,1,1,0 ) ) * SpecularColor103_g1187 * ( Specular102_g1187 * lightRatio37_g1187 ) * _UseSpecular );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;901;1008,-1308;Float;False;False;-1;3;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=792D2449AB7EF03FA29B74AFB78603B41B2CEFCE