	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 WorldPosition120_g1191 = worldPosValue102_g1191;
				...
				float4 ShadowMask120_g1191 = shadowMaskValue113_g1191;
				float temp_output_123_0_g1191 = _AdditionalLightRamp;
				float Ramp120_g1191 = temp_output_123_0_g1191;
				float3 localAdditionalLightsFlatMask10x120_g1191 = AdditionalLightsFlatMask10x( WorldPosition120_g1191 , ShadowMask120_g1191 , Ramp120_g1191 );
				float3 normalizeResult129_g1191 = normalize( localAdditionalLightsFlatMask10x120_g1191 );
				float3 temp_output_126_0_g1191 = ( length( localAdditionalLightsFlatMask10x120_g1191 ) > 1.0 ? normalizeResult129_g1191 : localAdditionalLightsFlatMask10x120_g1191 );
...
ASEEND*/
//CHKSM=06C4046637B804A4FFBEE78A1BA3D30AFF1B7E45