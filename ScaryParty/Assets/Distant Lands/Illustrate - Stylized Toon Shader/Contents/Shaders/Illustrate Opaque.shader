...
eturn SampleProbeVolumePixel( SampleSH( normalWS ), positionWS, normalWS, viewDirWS, input.positionCS.xy );
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_30_0_g1205 = length( ( float4( temp_output_22_0_g1205 , 0.0 ) * input.ase_color ) );
				...
				float3 objToWorldDir5_g1213 = mul( GetObjectToWorldMatrix(), float4( _TriplanarDirection, 0.0 ) ).xyz;
				...
				float2 texCoord23_g1201 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1201 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1201).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (input.ase_texcoord10.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1201 : float2( 0,0 ) ) );
				...
				float2 texCoord23_g1199 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1199 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1199).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (input.ase_texcoord10.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1199 : float2( 0,0 ) ) );
				...
				float2 texCoord23_g1200 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1200 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1200).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (input.ase_texcoord10.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1200 : float2( 0,0 ) ) );
				...
				float3 bakedGI361_g1189 = ASEIndirectDiffuse( input, ase_normalWS, WorldPosition, WorldViewDirection );
				Light ase_mainLight = GetMainLight( ShadowCoords );
				MixRealtimeAndBakedGI( ase_mainLight, ase_normalWS, bakedGI361_g1189, half4( 0, 0, 0, 0 ) );
				...
				float2 coords288_g1189 = (( ase_positionSSNorm * _ScreenParams )*_HalftoneScale + 0.0).xy * 0.02;
				...
				float4 lerpResult22_g1189 = lerp( ( multiplyByLightColor201_g1189 == 1.0 ? ( float4( bakedGI361_g1189 , 0.0 ) * _ShadowColor ) : _ShadowColor ) , ( multiplyByLightColor201_g1189 == 1.0 ? ( ase_lightColor * _LightColor ) : _LightColor ) , lightRatio37_g1189);
				float4 FinalLighting134_g1189 = lerpResult22_g1189;
				float normalizeResult129_g1191 = normalize( 0.0 );
				float temp_output_126_0_g1191 = ( length( 0.0 ) > 1.0 ? normalizeResult129_g1191 : 0.0 );
				float temp_output_133_0_g1191 = _LightSteps;
				float FlatResult131_g1191 = ( _PosterizeLight == 1.0 ? ( round( ( temp_output_126_0_g1191 * temp_output_133_0_g1191 ) ) / temp_output_133_0_g1191 ) : temp_output_126_0_g1191 );
				float posterizedLight236_g1189 = FlatResult131_g1191;
				float4 appendResult281_g1189 = (float4((( lightMode277_g1189 == 1.0 ? ( FinalLighting134_g1189 + posterizedLight236_g1189 ) : float4( 1,1,1,1 ) )).rgb , 1.0));
				...
				float3 normalizeResult4_g1190 = normalize( ( WorldViewDirection + _MainLightPosition.xyz ) );
				float3 ModifiedNormal155_g1189 = ( _UseModifiedNormals == 0.0 ? ase_normalWS : temp_output_191_0_g1189 );
				...
				float4 FinalSpecular133_g1189 = ( ( multiplyByLightColor201_g1189 == 1.0 ? ase_lightColor : float4( 1,1,1,0 ) ) * SpecularColor103_g1189 * ( Specular102_g1189 * lightRatio37_g1189 ) * _UseSpecular );
				float4 RimColor119_g1189 = _RimLightColor;
				float temp_output_127_0_g1189 = ( _RimRamp * 0.5 );
				float dotResult124_g1189 = dot( ModifiedNormal155_g1189 , WorldViewDirection );
				...
				float2 texCoord5_g1166 = input.ase_texcoord6.xy * temp_cast_13 + float2( 0,0 );
...
ASEEND*/
//CHKSM=707225805C333C14E10058724C9B30EAE397E5B3