...
eturn SampleProbeVolumePixel( SampleSH( normalWS ), positionWS, normalWS, viewDirWS, input.positionCS.xy );
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 temp_output_23_0_g1214 = input.positionOS.xyz;
				...
				float2 temp_cast_1 = (input.ase_vertexId*( _FlutterNoiseScale * 0.1 ) + ( ( round( ( _TimeParameters.x * temp_output_2_0_g1213 ) ) / temp_output_2_0_g1213 ) * 0.1 * _FlutterSpeed ));
				float simplePerlin2D12_g1212 = snoise( temp_cast_1*8.91 );
				float3 worldToObjDir34_g1212 = normalize( mul( GetWorldToObjectMatrix(), float4( _FlutterDirection, 0.0 ) ).xyz );
				float temp_output_21_0_g1217 = _SwirlSource;
				float3 temp_output_23_0_g1217 = input.positionOS.xyz;
				...
				float temp_output_30_0_g1217 = length( ( float4( temp_output_22_0_g1217 , 0.0 ) * input.ase_color ) );
				float3 worldToObjDir40_g1215 = normalize( mul( GetWorldToObjectMatrix(), float4( _SwirlDirection, 0.0 ) ).xyz );
				float temp_output_2_0_g1216 = _SwirlFramerate;
				float simplePerlin2D12_g1215 = snoise( (input.positionOS.xyz*( _SwirlNoiseScale * 0.1 ) + ( ( round( ( _TimeParameters.x * temp_output_2_0_g1216 ) ) / temp_output_2_0_g1216 ) * 0.1 * _SwirlSpeed )).xy*8.91 );
				float3 rotatedValue35_g1215 = RotateAroundAxis( float3( 0,0,0 ), input.positionOS.xyz, worldToObjDir40_g1215, ( _SwirlAmount * 0.01 * simplePerlin2D12_g1215 ) );
				float temp_output_21_0_g1220 = _SwaySource;
				float3 temp_output_23_0_g1220 = input.positionOS.xyz;
				...
				float temp_output_30_0_g1220 = length( ( float4( temp_output_22_0_g1220 , 0.0 ) * input.ase_color ) );
				float temp_output_2_0_g1219 = _SwayFramerate;
				float simplePerlin2D5_g1218 = snoise( (input.positionOS.xyz*( _SwayNoiseScale * 0.1 ) + ( ( round( ( _TimeParameters.x * temp_output_2_0_g1219 ) ) / temp_output_2_0_g1219 ) * 0.1 * _SwaySpeed )).xy*8.91 );
				simplePerlin2D5_g1218 = simplePerlin2D5_g1218*0.5 + 0.5;
				float3 worldToObjDir18_g1218 = normalize( mul( GetWorldToObjectMatrix(), float4( _SwayDirection, 0.0 ) ).xyz );
				float temp_output_21_0_g1223 = _WaveSource;
				float3 temp_output_23_0_g1223 = input.positionOS.xyz;
				...
				float temp_output_30_0_g1223 = length( ( float4( temp_output_22_0_g1223 , 0.0 ) * input.ase_color ) );
				float3 ase_positionWS = TransformObjectToWorld( ( input.positionOS ).xyz );
				float3 normalizeResult37_g1221 = normalize( _WaveDirection1 );
				float3 break35_g1221 = ( ase_positionWS * normalizeResult37_g1221 );
				...
				float3 break49_g1221 = ( ase_positionWS * normalizeResult52_g1221 );
				float3 worldToObjDir18_g1221 = normalize( mul( GetWorldToObjectMatrix(), float4( _WaveInfluenceDirection, 0.0 ) ).xyz );
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_30_0_g1234 = length( ( float4( temp_output_22_0_g1234 , 0.0 ) * input.ase_color ) );
				...
				float3 objToWorldDir37_g1203 = mul( GetObjectToWorldMatrix(), float4( normalizeResult6_g1203, 0.0 ) ).xyz;
				float3 objToWorldDir31_g1203 = mul( GetObjectToWorldMatrix(), float4( _CustomNormalDirection, 0.0 ) ).xyz;
				...
				float3 objToWorldDir5_g1239 = mul( GetObjectToWorldMatrix(), float4( _TriplanarDirection, 0.0 ) ).xyz;
				...
				float2 texCoord23_g1227 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1227 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1227).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (input.ase_texcoord10.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1227 : float2( 0,0 ) ) );
				...
				float2 texCoord23_g1225 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1225 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1225).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (input.ase_texcoord10.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1225 : float2( 0,0 ) ) );
				...
				float2 texCoord23_g1226 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 Source25_g1226 = ( ( _VariationSource == 0.0 ? (WorldPosition).xz : float2( 0,0 ) ) + ( _VariationSource == 1.0 ? (objToWorld17_g1226).xz : float2( 0,0 ) ) + ( _VariationSource == 2.0 ? (input.ase_texcoord10.xyz).xz : float2( 0,0 ) ) + ( _VariationSource == 3.0 ? texCoord23_g1226 : float2( 0,0 ) ) );
				...
				float3 bakedGI361_g1204 = ASEIndirectDiffuse( input, ase_normalWS, WorldPosition, WorldViewDirection );
				Light ase_mainLight = GetMainLight( ShadowCoords );
				MixRealtimeAndBakedGI( ase_mainLight, ase_normalWS, bakedGI361_g1204, half4( 0, 0, 0, 0 ) );
				...
				float2 coords288_g1204 = (( ase_positionSSNorm * _ScreenParams )*_HalftoneScale + 0.0).xy * 0.02;
				...
				float4 lerpResult22_g1204 = lerp( ( multiplyByLightColor201_g1204 == 1.0 ? ( float4( bakedGI361_g1204 , 0.0 ) * _ShadowColor ) : _ShadowColor ) , ( multiplyByLightColor201_g1204 == 1.0 ? ( ase_lightColor * _LightColor ) : _LightColor ) , lightRatio37_g1204);
				float4 FinalLighting134_g1204 = lerpResult22_g1204;
				float normalizeResult129_g1206 = normalize( 0.0 );
				float temp_output_126_0_g1206 = ( length( 0.0 ) > 1.0 ? normalizeResult129_g1206 : 0.0 );
				float temp_output_133_0_g1206 = _LightSteps;
				float FlatResult131_g1206 = ( _PosterizeLight == 1.0 ? ( round( ( temp_output_126_0_g1206 * temp_output_133_0_g1206 ) ) / temp_output_133_0_g1206 ) : temp_output_126_0_g1206 );
				float posterizedLight236_g1204 = FlatResult131_g1206;
				float4 appendResult281_g1204 = (float4((( lightMode277_g1204 == 1.0 ? ( FinalLighting134_g1204 + posterizedLight236_g1204 ) : float4( 1,1,1,1 ) )).rgb , 1.0));
				...
				float3 normalizeResult4_g1205 = normalize( ( WorldViewDirection + _MainLightPosition.xyz ) );
				float3 ModifiedNormal155_g1204 = ( _UseModifiedNormals == 0.0 ? ase_normalWS : temp_output_191_0_g1204 );
				...
				float4 FinalSpecular133_g1204 = ( ( multiplyByLightColor201_g1204 == 1.0 ? ase_lightColor : float4( 1,1,1,0 ) ) * SpecularColor103_g1204 * ( Specular102_g1204 * lightRatio37_g1204 ) * _UseSpecular );
				float4 RimColor119_g1204 = _RimLightColor;
				float temp_output_127_0_g1204 = ( _RimRamp * 0.5 );
				float dotResult124_g1204 = dot( ModifiedNormal155_g1204 , WorldViewDirection );
				...
				float2 texCoord5_g1210 = input.ase_texcoord6.xy * temp_cast_13 + float2( 0,0 );
				float4 UVs26_g1210 = ( _EmissionUVSource == 0.0 ? float4( texCoord5_g1210, 0.0 , 0.0 ) : (ase_positionSSNorm*_EmissionEffectScale + 0.0) );
				...
				float2 texCoord48_g1211 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult20_g1211 = (float2(ase_positionSSNorm.xy));
				...
				float dotResult33_g1211 = dot( normalizedWorldNormal , WorldViewDirection );
				...
				float2 texCoord18_g1240 = input.ase_texcoord6.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float time3_g1240 = 0.0;
				float2 voronoiSmoothId3_g1240 = 0;
				float2 texCoord18_g1240 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 coords3_g1240 = texCoord18_g1240 * ( 1.0 / _DissolveScale );
				float2 id3_g1240 = 0;
				float2 uv3_g1240 = 0;
				float voroi3_g1240 = voronoi3_g1240( coords3_g1240, time3_g1240, id3_g1240, uv3_g1240, 0, voronoiSmoothId3_g1240 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				float time3_g1240 = 0.0;
				float2 voronoiSmoothId3_g1240 = 0;
				float2 texCoord18_g1240 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 coords3_g1240 = texCoord18_g1240 * ( 1.0 / _DissolveScale );
				float2 id3_g1240 = 0;
				float2 uv3_g1240 = 0;
				float voroi3_g1240 = voronoi3_g1240( coords3_g1240, time3_g1240, id3_g1240, uv3_g1240, 0, voronoiSmoothId3_g1240 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;867;1040,-1212;Float;False;False;-1;3;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=A8BF2801713CE646F68E7758BE0970AD9F40C005